module.exports = (function(e, t) {
  ...
  104: function(e, t, r) {
    ...
    const n = r(469);
    try {
      const e = i.getInput("labels-to-fail");
      const t = e.split(",");
      ...
      let {
        pull_request: { labels: r }
      } = n.context.payload;
      r = r.map(({ name: e }) => e);
      const s = r.filter(e => t.includes(e));
      if (s.length) {
        const e = s.join(", ");
        console.log(`Labels to Fail found: ${e}`);
        throw new Error(`Labels to Fail found: ${e}`);
      }
      process.exit(0);
    } catch (e) {
    ...
    e.exports = {
      _args: [
        [
          ...
          "D:\\coding\\js\\testing-stuff\\.github\\actions\\labels-to-fail"
        ]
      ],
      ...
      _spec: "16.43.1",
      _where: "D:\\coding\\js\\testing-stuff\\.github\\actions\\labels-to-fail",
  ...
  280: function(e, t) {
    ...
    Comparator.prototype.parse = function(e) {
      var t = this.options.loose ? o[$] : o[M];
      var r = e.match(t);
      if (!r) {
        ...
        [Symbol.asyncIterator]: () => ({
          next() {
            ...
            return e.request({ method: n, url: o, headers: s }).then(t => {
              ...
              o = ((t.headers.link || "").match(/<([^>]+)>;\s*rel="next"/) ||
                [])[1];
              return { value: t };
            });
          }
  ...
  469: function(e, t, r) {
    ...
    class GitHub extends s.Octokit {
      ...
      static getProxyAgent(e) {
        var t;
        if (!((t = e.request) === null || t === void 0 ? void 0 : t.agent)) {
  ...
  470: function(e, t, r) {
    ...
    function exportVariable(e, t) {
      process.env[e] = t;
      s.issueCommand("set-env", { name: e }, t);
    }
  ...
  539: function(e, t, r) {
    ...
    class HttpClient {
      ...
      async request(e, t, r, n) {
        ...
        let a =
          this._allowRetries && g.indexOf(e) != -1 ? this._maxRetries + 1 : 1;
        let p = 0;
        let c;
        while (p < a) {
          ...
          while (
            d.indexOf(c.message.statusCode) != -1 &&
      ...
      return n(
        ...
        .then(n => {
          ...
          if (e.method === "HEAD") {
            ...
            throw new a.RequestError(n.statusText, r, {
              headers: t,
              request: e
            });
          }
  ...
  883: function(e) {
    ...
    var A = P ? P.prototype : undefined,
      G = A ? A.toString : undefined;
    function Hash(e) {
      var t = -1,
        r = e ? e.length : 0;
      this.clear();
  ...
  898: function(e, t, r) {
    ...
    function graphql(e, t, r) {
      r =
        typeof t === "string" ? (r = Object.assign({ query: t }, r)) : (r = t);
